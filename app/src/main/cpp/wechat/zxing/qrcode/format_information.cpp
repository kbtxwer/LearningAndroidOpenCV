...
namespace zxing {
    namespace qrcode {
        ...
        FormatInformation::FormatInformation(int formatInfo, float possiableFix,
                                             ErrorHandler &err_handler)
                : errorCorrectionLevel_(
                ErrorCorrectionLevel::forBits((formatInfo >> 3) & 0x03, err_handler)),
        ...
        FormatInformation::getErrorCorrectionLevel() { return errorCorrectionLevel_; }

...
// bottomLeft_ => centerA
        void
        FinderPatternInfo::calculateSides(Ref<FinderPattern> centerA, Ref<FinderPattern> centerB,
        ...
        void FinderPatternInfo::estimateFinderPatternInfo() {
            ...
            float CosLong =
                    (shortSide1 + shortSide2 - longSide) /
                    (2 * sqrt(shortSide1) * sqrt(shortSide2));
            float CosShort1 =
            ...
            int totalCount = (bottomLeft_->getCount() + topLeft_->getCount() +
                              topRight_->getCount());

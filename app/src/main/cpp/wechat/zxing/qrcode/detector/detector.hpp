...
// Possible Detect Result
        ...
        protected:
            ...
            static int computeDimension(Ref<ResultPoint> topLeft, Ref<ResultPoint> topRight,
                                        Ref<ResultPoint> bottomLeft, float moduleSizeX,
                                        float moduleSizeY);
            ...
            findAlignmentInRegion(float overallEstModuleSize, int estAlignmentX,
            ...
            bool checkTolerance(Ref<ResultPoint> &topLeft, Ref<ResultPoint> &topRight,
                                Rect &topRightRect,
        ...
        public:
            ...
            static Ref<BitMatrix>
            sampleGrid(Ref<BitMatrix> image, int dimension, Ref<PerspectiveTransform>,
                       ErrorHandler &err_handler);

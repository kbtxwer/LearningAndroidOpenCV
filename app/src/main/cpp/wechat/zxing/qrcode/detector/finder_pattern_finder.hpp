...
namespace zxing {
    ...
    namespace qrcode {
        ...
        protected:
            ...
            bool
            crossCheckDiagonal(int startI, int centerJ, int maxCount, int originalStateCountTotal);

            float crossCheckVertical(size_t startI, size_t centerJ, int maxCount,
                                     int originalStateCountTota,
            ...
            std::vector<Ref<FinderPattern> >
            orderBestPatterns(std::vector<Ref<FinderPattern> > patterns);

            vector<Ref<FinderPatternInfo> > getPatternInfosFileMode(DecodeHints const &hints,
                                                                    ErrorHandler &err_handler);

            bool IsPossibleFindPatterInfo(Ref<FinderPattern> a, Ref<FinderPattern> b,
                                          Ref<FinderPattern> c);
        ...
        public:
            ...
            std::vector<Ref<FinderPatternInfo> >
            find(DecodeHints const &hints, ErrorHandler &err_handler);

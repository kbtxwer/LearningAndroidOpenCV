...
namespace zxing {
    namespace qrcode {
        ...
        Version *
        Version::getProvisionalVersionForDimension(int dimension, ErrorHandler &err_handler) {
            if (dimension % 4 != 1) {
        ...
        Ref<BitMatrix> Version::buildFixedPatternValue(ErrorHandler &err_handler) {
            ...
            for (size_t x = 0; x < max; x++) {
                ...
                for (size_t y = 0; y < max; y++) {
                    ...
                    fixedInfo->flipRegion(alignmentPatternCenters_[y] - 1, i + 1, 3, 3,
                                          err_handler);
        ...
        int Version::buildVersions() {
            ...
            VERSIONS.push_back(
                    Ref<Version>(
                            new Version(8, intArray(3, 6, 24, 42), new ECBlocks(24, new ECB(2, 97)),
            ...
            VERSIONS.push_back(Ref<Version>(
                    new Version(32, intArray(6, 6, 34, 60, 86, 112, 138),

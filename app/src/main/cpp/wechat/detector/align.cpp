...
namespace cv {
    namespace wechat_qrcode {
        ...
        Mat Align::crop(const Mat &inputImg, const int width, const int height) {
            ...
            warpPerspective(inputImg, warp_dst, M_, warp_dst.size(), INTER_LINEAR, BORDER_CONSTANT,
                            255);

            return warp_dst;
        }

        Mat Align::crop(const Mat &inputImg, const Mat &srcPts, const float paddingW,

...
namespace cv {
    namespace wechat_qrcode {
        ...
        public:
            ...
            ImgSource(unsigned char *pixels, int width, int height, int left, int top,
                      int cropWidth,
                      int cropHeight, zxing::ErrorHandler &err_handler);

            static zxing::Ref<ImgSource> create(unsigned char *pixels, int width, int height);

            static zxing::Ref<ImgSource>
            create(unsigned char *pixels, int width, int height, int left,

 ...
 */
        ...
        public:
            ...
            CV_WRAP
            IntelligentScissorsMB &
            setWeights(float weight_non_edge, float weight_gradient_direction,
            ...
            CV_WRAP
            IntelligentScissorsMB &
            setEdgeFeatureZeroCrossingParameters(float gradient_magnitude_min_value = 0.0f);
            ...
            IntelligentScissorsMB &applyImageFeatures(
                    InputArray non_edge, InputArray gradient_direction,
             ...
             */
            CV_WRAP void
            getContour(const Point &targetPt, OutputArray contour, bool backward = false) const;
